...
const ServicesPage = ({ onCalculatePrice }: ServicesPageProps = {}) => {
  ...
  const handleOrderClick = () => {
    if (onCalculatePrice) {
      ...
      // Fallback to home page calculator if no prop provided
      navigate('/');
      setTimeout(() => {
        const calculatorButton = document.querySelector('[data-calculator-trigger]');
                    ...
                    >
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        ...
                        <button 
                          ...
                          className="w-full flex items-center justify-center gap-2 text-green-600 border border-green-500 bg-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-300 hover:bg-green-50 active:scale-95"
                        >
